...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ob-async camcorder zetteldeft dired-recent fasd bbdb speed-type fortune-cookie ranger pass org-drill org-chef nnir-est mentor fish-completion circe anki-editor)))
